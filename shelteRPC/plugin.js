(() => {
  ...
  var classes = { "trash": "zS7Qtq_trash", "cardNone": "zS7Qtq_cardNone", "cardPlaying": "zS7Qtq_cardPlaying", "gameCardIcons": "zS7Qtq_gameCardIcons", "gameCardInfo": "zS7Qtq_gameCardInfo", "gameCardName": "zS7Qtq_gameCardName", "cardPlayed": "zS7Qtq_cardPlayed", "lastPlayedTimestamp": "zS7Qtq_lastPlayedTimestamp", "gameCard": "zS7Qtq_gameCard", "gameCardLastPlayed": "zS7Qtq_gameCardLastPlayed" };
...
`;
  ...
  var classes3 = { "shead": "yVnOSq_shead", "addIt": "yVnOSq_addIt", "modalhead": "yVnOSq_modalhead", "description": "yVnOSq_description", "tophead": "yVnOSq_tophead" };
...
`;
  ...
  var onLoad = () => __async(void 0, null, function* () {
    ...
    const connected = yield retry((curTry) => __async(void 0, null, function* () {
      var _a2, _b2, _c;
      ws = new WebSocket(`ws://127.0.0.1:${(_a2 = store3.arRpcPort) != null ? _a2 : 1337}`);
      ...
      if (ws.readyState !== WebSocket.OPEN) {
        (_b2 = ws == null ? void 0 : ws.close) == null ? void 0 : _b2.call(ws);
        ws = null;
        showToast({
          title: "ShelteRPC",
          content: `Unable to connect to ShelteRPC server (${curTry})`,
          duration: (_c = store3.retryWait) != null ? _c : 3e3
        });
        return false;
      }
      return true;
  ...
  var settings = () => [(0, import_web27.createComponent)(Header2, {
    ...
    (0, import_web25.insert)(_el$4, (0, import_web27.createComponent)(TextBox2, {
      get value() {
        var _a;
        return (_a = store3.arRpcPort) != null ? _a : 1337;
      },
      onInput: (v) => store3.arRpcPort = v,
      type: "number"
    }), null);
