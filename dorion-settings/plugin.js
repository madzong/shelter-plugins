(() => {
  ...
  var classes = { "stext": "ZN8ggW_stext", "tophead": "ZN8ggW_tophead", "shead": "ZN8ggW_shead", "pbuttons": "ZN8ggW_pbuttons" };
...
`;
  ...
  var classes3 = { "card": "iitjua_card" };
  var css3 = `.iitjua_card {
...
`;
  ...
  var classes4 = { "restartButton": "_3UjfSq_restartButton", "restartCard": "_3UjfSq_restartCard" };
  var css4 = `._3UjfSq_restartCard {
...
`;
  ...
  var classes5 = { "splitbutton": "_2nPZKq_splitbutton", "shead": "_2nPZKq_shead", "pbuttons": "_2nPZKq_pbuttons", "sbutton": "_2nPZKq_sbutton", "tophead": "_2nPZKq_tophead" };
...
`;
  ...
  var classes7 = { "radioButtonInner": "Ch7osa_radioButtonInner", "radioButton": "Ch7osa_radioButton", "selected": "Ch7osa_selected", "radio": "Ch7osa_radio" };
...
`;
  ...
  var classes8 = { "refresh": "yPVoxW_refresh", "tophead": "yPVoxW_tophead", "card": "yPVoxW_card", "title": "yPVoxW_title", "spin": "yPVoxW_spin", "spinner": "yPVoxW_spinner", "contents": "yPVoxW_contents", "badges": "yPVoxW_badges", "badge": "yPVoxW_badge" };
...
`;
  ...
  var classes9 = { "top32": "XZjauW_top32", "plist": "XZjauW_plist", "left16": "XZjauW_left16", "shead": "XZjauW_shead", "sbutton": "XZjauW_sbutton", "pheader": "XZjauW_pheader", "pbuttons": "XZjauW_pbuttons", "mcell": "XZjauW_mcell", "scell": "XZjauW_scell", "top16": "XZjauW_top16", "plistrow": "XZjauW_plistrow" };
...
`;
  ...
  var classes10 = { "sbutton": "V6is4W_sbutton", "left16": "V6is4W_left16", "top16": "V6is4W_top16", "top32": "V6is4W_top32", "scell": "V6is4W_scell", "pheader": "V6is4W_pheader", "plist": "V6is4W_plist", "pbuttons": "V6is4W_pbuttons", "plistrow": "V6is4W_plistrow", "mcell": "V6is4W_mcell" };
...
`;
  ...
  var classes11 = { "pbuttons": "X31w8G_pbuttons", "openButton": "X31w8G_openButton", "card": "X31w8G_card", "tophead": "X31w8G_tophead", "shead": "X31w8G_shead", "left16": "X31w8G_left16" };
...
`;
  ...
  var classes12 = { "pbuttons": "oAx4fa_pbuttons", "tophead": "oAx4fa_tophead", "shead": "oAx4fa_shead" };
  var css12 = `.oAx4fa_tophead {
  margin-bottom: 16px;
}
...
`;
  ...
  var installThemeModal = (addToList) => __async(void 0, null, function* () {
    ...
    openModal((props) => confirmModal({
      ...
      confirmText: "Install",
      type: "neutral",
      onConfirm: () => __async(void 0, null, function* () {
        const themeName = yield installAndLoad(link2(), setStatus).catch((e) => {
          setStatus(e);
        });
        addToList(themeName);
        props.close();
  ...
  var reloadThemes = () => __async(void 0, null, function* () {
    ...
    const themeNames = (yield invoke("get_enabled_themes").catch((e) => console.error(e))) || [];
  ...
  function ThemesPage() {
    ...
    const appendTheme = (last, theme) => __async(this, null, function* () {
      if (!theme)
        return;
      if (theme === "" || theme === "none") {
        setSettings((p) => {
  ...
  var classes13 = { "customNote": "ycw7DW_customNote", "shead": "ycw7DW_shead", "bot16": "ycw7DW_bot16", "customInstallBtn": "ycw7DW_customInstallBtn" };
